"""
source from
http://codereview.stackexchange.com/questions/81865/travelling-salesman-using-brute-force-and-heuristics#new-answer?newreg=4c6c638dd00c4b58aaaf5162b7cb4e57
"""
...
if __name__ == "__main__":
    ...
    points = [[0, 0], [1, 5.7], [2, 3], [3, 7], [0.5, 9], [3, 5], [9, 1], [10, 5]]

    dist_bruteForce = total_distance(travelling_salesman(points))
    dist_suboptimal = total_distance(optimized_travelling_salesman(points))

    print((textwrap.dedent(
        """
        The minimum distance to visit all the following points:
        {}
        BruteForce is {}.
        The optimized algorithm yields a path long {}.
        """
        .format(
            tuple(points),
            dist_bruteForce,
